...
// ********************************************************************
//
/// \file electromagnetic/TestEm12/src/NeutronHPMessenger2.cc
/// \brief Implementation of the NeutronHPMessenger2 class
//
// $Id: NeutronHPMessenger2.cc 67268 2013-02-13 11:38:40Z ihrivnac $
//
...
NeutronHPMessenger2::NeutronHPMessenger2(NeutronHPphysics* phys)
...
NeutronHPMessenger2::~NeutronHPMessenger2()
{
  delete fThermalCmd;
  delete fPhysDir;
}
...
void NeutronHPMessenger2::SetNewValue(G4UIcommand* command, G4String newValue)
{   
